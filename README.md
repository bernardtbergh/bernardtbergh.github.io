# Bernardt's Website
This is a temporary markdown file in place of a simple HTML, CSS, and JavaScript website, which will be developed from scratch. This creates a learning opportunity for me in front-end web development. At some point, this site will reference multiple other projects or even sites which will be self-hosted. These sites might be web applications in any field of study that might interest me, such as fluid-, thermodynamics, heat transfer principles and simulation. 
